...
from isaacsim.asset.importer.urdf import _urdf # isaac sim 2025.1
...
def save_usd():
    ...
    robot_config = load_yaml(args.robot)
    urdf_path = robot_config["robot_cfg"]["kinematics"]["urdf_path"]
    asset_path = robot_config["robot_cfg"]["kinematics"]["asset_root_path"]
    urdf_interface = _urdf.acquire_urdf_interface()
    full_path = robot_config["robot_cfg"]["kinematics"]["urdf_path"]
    ...
    save_path = robot_config["robot_cfg"]["kinematics"]["usd_path"]
